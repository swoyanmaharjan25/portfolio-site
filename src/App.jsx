...
export default function App() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-neutral-950 text-white selection:bg-white selection:text-black">
      <div className="pointer-events-none fixed inset-0 -z-10">
        ...
        <div className="absolute right-0 top-1/3 h-[300px] w-[300px] rounded-full bg-cyan-500/10 blur-3xl" />
      </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20 md:px-10 md:py-24">
        <div className="grid gap-12 md:grid-cols-[1.15fr_0.85fr] md:items-center">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.3em] text-neutral-300 backdrop-blur">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-300 md:text-xl">
              ...
              thoughtful products, and memorable experiences that feel premium and perform well.
            </p>

            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#projects"
                className="group inline-flex items-center rounded-2xl bg-white px-6 py-3 text-sm font-medium text-black shadow-[0_15px_40px_rgba(255,255,255,0.15)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(255,255,255,0.22)]"
              >
                View Projects
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-sm uppercase tracking-[0.25em] text-neutral-500">Services</p>
      ...
      <section id="projects" className="mx-auto max-w-6xl px-6 py-8 md:px-10 md:py-16">
        <div className="mb-10 flex items-end justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.35em] text-neutral-500">Selected Work</p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-8 md:px-10 md:py-16">
        <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 backdrop-blur md:p-10">
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              <p className="text-sm uppercase tracking-[0.35em] text-neutral-500">Why Me</p>
